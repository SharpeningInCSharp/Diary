...
namespace Diary.Views
{
	...
	public partial class ItemsPage : ContentPage
	{
		...
		public ItemsPage()
		{
			...
			//realm.Write(() =>
			//{
			//	realm.Remove(realm.All<PriorityEntity>().First(x => x.Name == "Low"));
			//	realm.Remove(realm.All<PriorityEntity>().First(x => x.Name == "Normal"));
			//	realm.Remove(realm.All<PriorityEntity>().First(x => x.Name == "Hight"));
